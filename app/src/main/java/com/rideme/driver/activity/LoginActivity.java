...
import com.rideme.driver.network.AppController;
...
import com.rideme.driver.service.MyFirebaseInstanceIdService;

import com.rideme.driver.BuildConfig;
                ...
                try {
                    if(obj.getString("message").equals("found")){
                        ...
                        if(loadImageFromServer(user.image)){
                            ...
                            Intent change = new Intent(activity, login.class);
                            startActivity(change);
                            finish();
                        }
                    }else if(obj.getString("message").equals("banned")){
                        pd.dismiss();
                        showWarning("Your Account had banned, please call our corporation");
                    }else{
                        pd.dismiss();
                        showWarning("Your Phone Number its wrong.");
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
