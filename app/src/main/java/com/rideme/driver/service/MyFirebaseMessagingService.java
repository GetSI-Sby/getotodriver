...
import com.rideme.driver.activity.NotificationActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static final String BROADCAST_ACTION = "com.rideme.driver";
...
//        Log.d("data_driver", driverpaojek.id+" "+new UserPreference(this).getDriver().longitude);
        Bundle bund = new Bundle();
