...
//                    Log.d("Status_from_server ", statLoc+" to "+driverpaojek.id);
...
//        Driver driverpaojek = new UserPreference(this).getDriver();
//        Content content = new Content();
//        content.addRegId(userRegID);
//        content.createDataLocation(driverpaojek.id, loc);
